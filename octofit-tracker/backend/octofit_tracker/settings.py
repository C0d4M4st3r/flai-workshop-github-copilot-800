...
SECRET_KEY = 'django-insecure-y9g5v4$*ob7p8-q)l70id#9jisdgm=adbrc6v2va)cxj2&@qjk'
...
if os.environ.get('CODESPACE_NAME'):
    ...
    ALLOWED_HOSTS.append(f"{codespace_name}-3000.{codespace_domain}")
...
if os.environ.get('CODESPACE_NAME'):
    ...
    CSRF_TRUSTED_ORIGINS.append(f"https://{codespace_name}-3000.{codespace_domain}")
